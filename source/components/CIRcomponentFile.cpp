...
//  
//===========================================================================
// Name     : CIRcomponentFile
// Arguments: None
// Purpose  : Constructor
// Notes    : 
//===========================================================================

CIRcomponentFile::CIRcomponentFile (const string & source_file) 
{
...
//
//===========================================================================
CIRcomponentFile::~CIRcomponentFile ( ) 
{
}
//===========================================================================
// Name     : construct
...
bool CIRcomponentFile::construct(const string & componentName)
{
   ...
   if (!inputStream) {
     cerr << "Error: Can't open file " << filename << " for component " << componentName << endl;
     return false;
   }
  ...
  // Now we can get on with the make
   ...
   while (getline(inputStream, line) && !error) {
    ...
    if  (equalPos < colonPos) { 
      ...
      unsigned int cBracketPos = componentId.find(")"); // in brackets following the name
      ...
      struct CIRcomponentDefinition def = {componentName, componentId, arg_list};
      m_componentDefinitions.push_back(def);
...
const string CIRcomponentFile::getFullComponentName(const string & fullSectionName,
                                                       const string & name)
{
...
bool CIRcomponentFile::finishedMake()
{
...
//
//===========================================================================
bool CIRcomponentFile::computeOutputs() 
{
...
//
void CIRcomponentFile::setComponentInputs()
{
...
bool CIRcomponentFile::computeComponentOutputs()
{
...
void CIRcomponentFile::setOutputBits()
{
  if (!m_finished) return;
